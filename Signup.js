  ...
  return (
    ...
    <div className="card-body">
      ...
      <form action="/"  encType="multipart/form-data" autoComplete="off">
        ...
        <div className="form-group">
          <label className="mb-0"> Create Password<span className="text-danger">*</span></label>
          <input name="password" type="password" className="form-control" placeholder="Password" />
        </div>
        <p className="text-center mb-0 mt-4"><Link type="submit" to="/Home" className="btn btn-primary btn-lg w-100 text-uppercase" >Sign up</Link></p>
